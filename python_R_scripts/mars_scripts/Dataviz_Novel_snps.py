...
novelMissenseName = timeStamp + '_SNPs-Novel-missense.pdf'
plt.savefig(novelMissenseName)
...
novelSynName = timeStamp + '_SNPs-Novel-synonymous.pdf'
plt.savefig(novelSynName)
